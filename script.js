...
let licenseKey = "BakrHabib_System"; // 🔒 تثبيت إجباري للسينيور

// الدالة دي بتولد مسار الداتابيز المخصوص للمدرس
function getFirebaseUrl() {
    return `https://new-0-2b6c6-default-rtdb.europe-west1.firebasedatabase.app/BakrHabib_System/data.json`;
}
...
window.getSafeUid = function() {
    return "BakrHabib_System"; // 🔒 التثبيت النهائي لمسار الداتا في كل الـ Fetches
};
...
function startRealTimeSync() {
    ...
    const syncUrl = `https://new-0-2b6c6-default-rtdb.europe-west1.firebasedatabase.app/BakrHabib_System/syncSignal.json`;
